    ...
    public class ContactProfile : Profile
    {
        ...
        public ContactProfile()
        {
            ...
            CreateMap<IDataResult<CreateContactResponse>, CreateContactProtoResponse>().
                    ForPath(dest => dest.Data.Id, opt => opt.MapFrom(src => src.Data.Data.Id)).
                    ForPath(dest => dest.Data.Salutation, opt => opt.MapFrom(src => src.Data.Data.Salutation)).
                    ForPath(dest => dest.Data.FirstName, opt => opt.MapFrom(src => src.Data.Data.FirstName)).
                    ForPath(dest => dest.Data.LastName, opt => opt.MapFrom(src => src.Data.Data.LastName)).
                    ForPath(dest => dest.Data.DisplayName, opt => opt.MapFrom(src => src.Data.Data.DisplayName)).
                    ForPath(dest => dest.Data.BirthDate, opt => opt.MapFrom(src => Timestamp.FromDateTime(src.Data.Data.BirthDate.ToUniversalTime()))).
                    ForPath(dest => dest.Data.CreationTimestamp, opt => opt.MapFrom(src => Timestamp.FromDateTime(src.Data.Data.CreationTimestamp.ToUniversalTime()))).
                    ForPath(dest => dest.Data.LastChangeTimeStamp, opt => opt.MapFrom(src => Timestamp.FromDateTime(src.Data.Data.LastChangeTimeStamp.ToUniversalTime()))).
                    ForPath(dest => dest.Data.NotifyHasBirthdaySoon, opt => opt.MapFrom(src => src.Data.Data.NotifyHasBirthdaySoon)).
                    ForPath(dest => dest.Data.Email, opt => opt.MapFrom(src => src.Data.Data.Email)).
                    ForPath(dest => dest.Data.Phonenumber, opt => opt.MapFrom(src => src.Data.Data.Phonenumber)).
